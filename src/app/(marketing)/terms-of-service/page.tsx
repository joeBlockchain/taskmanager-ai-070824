...
export default function PrivacyPolicy() {
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p>
        By accessing or using the TaskManager-AI (&quot;the Service&quot;), you
      ...
      <p>
        The Service is a kanban-style task manager system that allows users to
        create and manage projects, tasks, and deliverables.
      </p>

      <h2 className="text-2xl font-semibold mt-6 mb-4">3. User Accounts</h2>
      <p>
        You need a Google or GitHub account to use the Service. You are
      ...
      <p>
        ...
        using the Service, you grant us a license to use, modify, and display
      ...
      <p>
        ...
        Terms at any time. We will provide notice of changes by posting the
